// AKV-DATA-020 — kaynaklı tatlı su veri partisi 3 (16 kayıt)
;(() => {
  'use strict';
  ...
  const specs = window.AKV_FRESHWATER_BATCH_3_SPECS || [];

  if (specs.length !== 16) {
    throw new Error(`AKV-DATA-020 parti 3: 16 kayıt bekleniyordu, ${specs.length} bulundu.`);
  }
