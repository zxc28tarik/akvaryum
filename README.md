...
- `build`: başlamadan önce veri, kaynak, canlı/bitki/taban migrasyonları, öncelik 100, tank uzunluğu, taksonomi raporu ve katalog doğrulamalarını otomatik olarak yeniden çalıştırır.
